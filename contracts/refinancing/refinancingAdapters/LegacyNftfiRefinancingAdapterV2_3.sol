...
import {ILegacyDirectLoanBase} from "../../loans/loanTypes/ILegacyDirectLoanBase.sol";

/**
 * @title LegacyNftfiRefinancingAdapterV2_3
 * @author NFTfi
...
contract LegacyNftfiRefinancingAdapterV2_3 is IRefinancingAdapter {
    ...
    function getCollateral(
        ...
        (, , nftCollateralId, , , , , , , nftCollateralContract, ) = ILegacyDirectLoanBase(_loanContract).loanIdToLoan(
    ...
    function getPayoffDetails(
        ...
        //     address borrower;
        // }
        (, maximumRepaymentAmount, , loanERC20Denomination, , , , , , , ) = ILegacyDirectLoanBase(_loanContract)
    ...
    function _getCoordinator(address _loanContract) private view returns (ILoanCoordinator) {
        LoanBaseMinimal directLoan = LoanBaseMinimal(_loanContract);
        return ILoanCoordinator(directLoan.hub().getContract(directLoan.LOAN_COORDINATOR()));
    }
}
