...
interface IAssetVault {
    ...
    function withdrawERC1155(address token, uint256 tokenId, address to) external;
    ...
    function withdrawPunk(address punks, uint256 punkIndex, address to) external;

    function withdrawSuperRareV1(address superRareV1, uint256 tokenId, address to) external;
