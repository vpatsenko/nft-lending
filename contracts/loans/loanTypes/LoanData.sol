...
interface LoanData {
     ...
     * @param liquidityCap - max amount of liquidity that can be used for this signature
     * @param allowedBorrowers - list of addresses that can accept this offer. If empty,
     * then anyone can accept the offer
     */
    struct Offer {
        uint256 loanPrincipalAmount;
        uint256 maximumRepaymentAmount;
